...
- [🔷 先进空间平台技术](#先进空间平台技术)
  - [空间人工智能计算平台](#空间人工智能计算平台)
  - [新一代柔性、通用、智能卫星平台](#新一代柔性通用智能卫星平台)
  - [天空地一体化通信关键技术](#天空地一体化通信关键技术)
  
- [🔷 先进载荷技术](#先进载荷技术遥感通信导航)
  - [多源遥感信息融合技术](#多源遥感信息融合技术)
  - [高动态成像与三维重建](#高动态成像与三维重建)
  - [通信组网与随机接入技术](#通信组网与随机接入技术)
  - [空间智能导航与自主定位](#空间智能导航与自主定位)

- [🔷 多模态智能处理](#多模态智能处理)
  - [遥感图像智能处理与目标识别](#遥感图像智能处理与目标识别)
  - [视频智能分析与动态监测](#视频智能分析与动态监测)
  - [图像增强与复杂场景感知](#图像增强与复杂场景感知)
  - [多模态大模型与知识增强](#多模态大模型与知识增强)

- [🔷 空间环境探测技术](#空间环境探测技术)
  - [空间碎片智能识别与避障](#空间碎片智能识别与避障)
...
### 空间人工智能计算平台
通过部署[LLM](#Category2-1)解析任务指令，[VLM](#Category2-2)辅助图像语义理解，[Agent](#Category2-4)模块执行实时调度与任务规划，构建具备推理与感知能力的在轨AI计算平台。

### 新一代柔性、通用、智能卫星平台
结合[Video LM](#Category2-3)对平台运行状态的时序建模和[Agent](#Category2-4)智能调度机制，实现平台功能模块按需激活、任务灵活切换，满足多任务快速部署需求。

### 天空地一体化通信关键技术
借助[图像配准技术](#Category3)提高天线对准精度，结合[LLM](#Category2-1)进行协议解析与[Agent](#Category2-4)智能链路管理，实现天地链路在复杂场景下的稳定高效协同通信。
...
### 多源遥感信息融合技术
[多模态图像融合](#Category1-1)技术提升遥感图像在多源场景下的适应性，结合[VLM](#Category2-2)进行语义理解和分类。[目标检测技术](#Category6)算法则用于识别关键地物（如海上船只、建筑群），并通过大模型学习进一步优化识别精度，在城市监测与国土巡查中具重要价值。

### 高动态成像与三维重建
通过[多曝光图像融合](#Category5)提升在昼夜变化、高反光等环境下的图像质量，结合[三维重建技术](#Category4)精确还原地貌结构，服务于极端场景下的遥感监测与灾害评估。

### 通信组网与随机接入技术
面向激光卫星网络与低轨组网场景，[LLM](#Category2-1)分析任务流、[Agent](#Category2-4)动态调度通信资源，[VLM](#Category2-2)协助波束识别与对准，实现复杂组网环境下的高效通信接入。

### 空间智能导航与自主定位
融合[目标检测技术](#Category6)与[图像配准技术](#Category3)实现复杂场景中的精准定位。[三维重建技术](#Category4)提供几何辅助，[VLM](#Category2-2)感知空间语义，[Agent](#Category2-4)完成路径推理与自主导航策略决策。
...
### 遥感图像智能处理与目标识别
通过[多模态图像融合](#Category1-1)与[图像增强](#Category5)技术提升数据质量，结合[VLM](#Category2-2)和[目标检测技术](#Category6)实现复杂背景下的高精度识别，适用于军事监视、环境监测等场景。

### 视频智能分析与动态监测
[Video LM](#Category2-3)对遥感视频序列进行实时建模，识别目标动态与异常行为，[Agent](#Category2-4)执行事件响应与智能调度，构建具身智能的动态遥感监测系统。

### 图像增强与复杂场景感知
面向低光照、多遮挡环境，采用[多曝光图像融合](#Category5)与[配准技术](#Category3)增强图像清晰度，[VLM](#Category2-2)进行语义识别，[目标检测技术](#Category6)确保关键信息提取。

### 多模态大模型与知识增强
整合[LLM](#Category2-1)与[VLM](#Category2-2)构建统一多模态感知系统，[Agent](#Category2-4)协调任务分配与知识调用，实现遥感、导航等任务中知识驱动的跨模态推理与增强。
...
### 空间碎片智能识别与避障
基于[图像配准技术](#Category3)与[目标检测技术](#Category6)实现碎片智能识别，通过[三维重建技术](#Category4)估计其运动状态，[VLM](#Category2-2)理解碎片外观与语义信息，[Agent](#Category2-4)快速决策规避策略保障任务安全。
